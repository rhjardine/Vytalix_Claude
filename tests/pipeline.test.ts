...
import { IngestionService } from '../src/shared/ingestion.service'
import { PipelineOrchestrator } from '../src/api/pipelines/orchestrator'
...
describe('Full Clinical Pipeline Integration', () => {
  ...
  describe('Stage 3: Risk Scoring', () => {
    it('computes cardiovascular risk when critical fields are present', async () => {
      ...
      const { RiskScoringService } = await import('../../src/shared/risk-scoring.service')
