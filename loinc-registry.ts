...
export interface LoincEntry {
  code: string
  displayName: string
  canonicalUnit: string          // UCUM canonical unit for storage
  category: LoincCategory
  snapshotField?: string         // Corresponding PatientHealthSnapshot field name
  bounds: {
    physiologicalMin: number     // Absolute minimum — values below = reject
    physiologicalMax: number     // Absolute maximum — values above = reject
    clinicalAlertLow?: number    // Values below trigger a data quality warning
    clinicalAlertHigh?: number   // Values above trigger a data quality warning
  }
...
export interface UnitConversion {
  ...
  toCanonicalFormula: string     // Human-readable formula for audit trail
}
...
// -----------------------------------------------------------------------------
// Registry — expand as needed; each new LOINC code is a pull request
// -----------------------------------------------------------------------------
const registry: Record<string, LoincEntry> = {
  ...
  '2089-1': {
    ...
    canonicalUnit: 'mg/dL',
    category: 'LIPIDS',
    snapshotField: 'latestLdlMgDl',
    bounds: {
      physiologicalMin: 10,
      physiologicalMax: 800,
      clinicalAlertLow: 40,
      clinicalAlertHigh: 300,
    },
    unitConversions: [
      {
        fromUnit: 'mmol/L',
  ...
  '2085-9': {
    ...
    canonicalUnit: 'mg/dL',
    category: 'LIPIDS',
    snapshotField: 'latestHdlMgDl',
    bounds: {
      physiologicalMin: 10,
      physiologicalMax: 200,
      clinicalAlertLow: 30,
      clinicalAlertHigh: 120,
    },
    unitConversions: [
      {
        fromUnit: 'mmol/L',
  ...
  '2093-3': {
    ...
    canonicalUnit: 'mg/dL',
    category: 'LIPIDS',
    snapshotField: 'latestTotalCholesterol',
    bounds: {
      physiologicalMin: 50,
      physiologicalMax: 1000,
      clinicalAlertLow: 100,
      clinicalAlertHigh: 400,
    },
    unitConversions: [
      {
        fromUnit: 'mmol/L',
  ...
  '8480-6': {
    ...
    snapshotField: 'latestSystolicBp',
    bounds: {
      physiologicalMin: 50,
      physiologicalMax: 280,
      clinicalAlertLow: 80,
      clinicalAlertHigh: 200,
    },
    unitConversions: [
      {
        fromUnit: 'kPa',
  ...
  '8462-4': {
    ...
    canonicalUnit: 'mmHg',
    category: 'BLOOD_PRESSURE',
    snapshotField: 'latestDiastolicBp',
    bounds: {
      physiologicalMin: 30,
      physiologicalMax: 160,
      clinicalAlertLow: 50,
      clinicalAlertHigh: 130,
    },
    unitConversions: [
      {
        fromUnit: 'kPa',
  ...
  '2345-7': {
    ...
    canonicalUnit: 'mg/dL',
    category: 'GLUCOSE',
    snapshotField: 'latestFastingGlucose',
    bounds: {
      physiologicalMin: 20,
      physiologicalMax: 1200,
      clinicalAlertLow: 60,
      clinicalAlertHigh: 500,
    },
    unitConversions: [
      {
        fromUnit: 'mmol/L',
  ...
  '4548-4': {
    ...
    bounds: {
      ...
      physiologicalMax: 20,
      clinicalAlertLow: 4,
      clinicalAlertHigh: 14,
    },
    unitConversions: [
      {
        fromUnit: 'mmol/mol',
        toCanonical: (v) => parseFloat(((v / 10.929) + 2.15).toFixed(1)),
        toCanonicalFormula: '% = (mmol/mol / 10.929) + 2.15 (IFCC to NGSP)',
      },
    ],
  },
  ...
  '2160-0': {
    ...
    category: 'RENAL',
    bounds: {
      physiologicalMin: 0.1,
      physiologicalMax: 30,
      clinicalAlertLow: 0.4,
      clinicalAlertHigh: 10,
    },
    unitConversions: [
      {
        fromUnit: 'μmol/L',
  ...
  '30522-7': {
    code: '30522-7',
    displayName: 'C-Reactive Protein (high sensitivity)',
    canonicalUnit: 'mg/L',
    category: 'INFLAMMATORY',
    bounds: {
      physiologicalMin: 0.01,
      physiologicalMax: 500,
      clinicalAlertHigh: 100,
    },
    unitConversions: [
      {
        fromUnit: 'mg/dL',
...
export function normalizeUnit(
  ...
  if (!conversion) {
    // Unknown unit — store as-is with a warning flag upstream
    return { normalizedValue: value, normalizedUnit: inputUnit, conversionApplied: false }
  }
